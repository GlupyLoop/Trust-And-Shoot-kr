...
export default function MainHeroSection() {
  ...
  return (
    <div className="relative min-h-[80vh] bg-gradient-to-br from-[#0a0a0a] via-[#141414] to-[#1a1a1a] overflow-hidden mt-8">
      ...
      {/* Main content */}
      <div className="relative z-10 container mx-auto px-4 py-24 flex flex-col items-center justify-center min-h-[80vh] text-center">
